    ...
    return (
        <>
            <div className="row m-2">
                <div className="col-md-11 p-0 mb-4">
                <form onSubmit={obtenerDispositivo} className="d-flex" method="POST" autoComplete="off">
                    <input onChange={onInputChange} value={servicio} className="form-control me-2" name="servicio" type="search" placeholder="Search" aria-label="Search" />
                    <button className="btn btn-success" type="submit">Buscar</button>
                </form>
                </div>
                { dispositivos.map((item) => (
                    <div key={item.id} className="card p-0 mb-4 col-sm-12 col-md-11 animate__animated animate__fadeInUp" >
